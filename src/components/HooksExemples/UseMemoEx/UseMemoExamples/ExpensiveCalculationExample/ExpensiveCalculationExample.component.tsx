...
import '@/components/HooksExemples/UseMemoEx/UseMemoExample.style.scss';
import ExpensiveCalculationExampleDesc from './ExpensiveCalculationExampleDesc/ExpensiveCalculationExampleDesc.component';
