...
import ExpensiveCalculationExample from './UseMemoExamples/ExpensiveCalculationExample/ExpensiveCalculationExample';
import ProductFilterExample from './UseMemoExamples/ProductFilterExample/ProductFilterExample';
    ...
    return (
        <div className='example-container'>
            <div className='example-header'>
                ...
                <p>Простыми словами: Вы натерли на терке овощи для салата и сложили в миску. Если сами овощи не поменялись, вы не будете тереть их заново каждый раз, когда кто-то заходит на кухню. Вы используете заготовку.</p>
                <p>Как работает:</p>
