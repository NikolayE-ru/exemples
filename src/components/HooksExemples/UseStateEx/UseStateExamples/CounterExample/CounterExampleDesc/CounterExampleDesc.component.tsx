    ...
    return (
        <AccordionExempleDesc title='Описание примера 1: Счетчик'>
            <div className='description-container'>
                ...
                <SyntaxHighlighter language='javascript' style={coy} className='code-highlighter'>
                    {codeExample}
                </SyntaxHighlighter>
            ...
            <div>
                <p>
                    Этот пример демонстрирует базовое использование хука <code>useState</code> для управления состоянием
                    счетчика.
                </p>
                ...
                <ul>
                    ...
                    <li>
                        При вызове <code>increment</code> или <code>decrement</code> компонент перерисовывается с новым
                        значением
                    </li>
                    <li>
