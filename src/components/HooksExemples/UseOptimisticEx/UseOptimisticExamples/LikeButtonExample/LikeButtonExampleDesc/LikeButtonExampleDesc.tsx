        ...
        <AccordionExempleDesc title='Описание примера 2: useOptimistic с useTransition'>
            ...
            <div>
                ...
                <ul>
                    ...
                    <li>Оптимистичное обновление может провалиться (сеть недоступна, сервер вернул ошибку, данные конфликтуют). Поэтому обычно <code>useOptimistic</code> используется вместе с <code>useTransition</code> (или <code>useActionState</code>). Это дает:
